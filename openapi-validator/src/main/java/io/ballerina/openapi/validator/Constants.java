...
public class Constants {
    ...
    static {
        ...
        httpCodes.put("TemporaryRedirect", "308");
        ...
        httpCodes.put("ProxyAuthenticationRequires", "407");
        ...
        httpCodes.put("UriTooLong", "413");
        httpCodes.put("UnsupportedMediaType", "414");
        httpCodes.put("RangeNotSatisfied", "415");
        httpCodes.put("ExpectationFailed", "416");
