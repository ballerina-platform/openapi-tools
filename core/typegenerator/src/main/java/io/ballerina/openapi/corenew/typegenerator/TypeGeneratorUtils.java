...
public class TypeGeneratorUtils {
    ...
    public static AnnotationNode generateConstraintNode(String typeName, Schema<?> fieldSchema)
        ...
        if (isConstraintAllowed(typeName, fieldSchema)) {
            ...
            if (ballerinaType.equals(GeneratorConstants.STRING)) {
                // Attributes : maxLength, minLength
                return generateStringConstraint(fieldSchema);
            } else if (ballerinaType.equals(GeneratorConstants.DECIMAL) || ballerinaType.equals(GeneratorConstants.FLOAT) || ballerinaType.equals(GeneratorConstants.INT) ||
                    ballerinaType.equals(GeneratorConstants.INT_SIGNED32)) {
