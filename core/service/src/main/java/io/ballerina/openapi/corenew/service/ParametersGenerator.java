...
import static io.ballerina.openapi.corenew.service.GeneratorConstants.DEFAULT_PARAM_COMMENT;
import static io.ballerina.openapi.corenew.service.GeneratorConstants.NILLABLE;
import static io.ballerina.openapi.corenew.service.ServiceDiagnosticMessages.OAS_SERVICE_103;
import static io.ballerina.openapi.corenew.service.ServiceDiagnosticMessages.OAS_SERVICE_104;
import static io.ballerina.openapi.corenew.service.ServiceDiagnosticMessages.OAS_SERVICE_105;
import static io.ballerina.openapi.corenew.service.ServiceDiagnosticMessages.OAS_SERVICE_106;
...
import static io.ballerina.openapi.corenew.typegenerator.GeneratorUtils.isArraySchema;
import static io.ballerina.openapi.corenew.typegenerator.GeneratorUtils.isMapSchema;
import static io.ballerina.openapi.corenew.typegenerator.GeneratorUtils.isObjectSchema;
        ...
        if (operation.getValue().getParameters() != null) {
            ...
            for (Parameter parameter : parameters) {
                ...
                if (parameter.get$ref() != null) {
                    ...
                    parameter = openAPI.getComponents().getParameters().get(referenceType);
                }
