...
Owners: @shafreenAnfar @dilanSachi @TharmiganK @lnash94                 
Reviewers: @shafreenAnfar @TharmiganK @lnash94           
Created: 2024/02/20          
Updated: 2024/02/20        
Edition: Swan Lake

The OpenAPI to Ballerina tool can generate a Ballerina service from an OpenAPI schema. This specification describes the OpenAPI to Ballerina service mapping.

## Table of contents

- [OpenAPI tool specification: OpenAPI to Ballerina](#openapi-tool-specification-openapi-to-ballerina)
