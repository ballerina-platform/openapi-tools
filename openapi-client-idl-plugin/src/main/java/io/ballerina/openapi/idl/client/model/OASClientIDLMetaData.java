...
/**
 * This class uses to contain all the metadata that use to generate client.
 *
 * @since 1.3.0
 */
public class OASClientIDLMetaData {
    ...
    public OASClientIDLMetaData(Builder oasClientIDLMetaDataBuilder) {
    ...
    public static class Builder {
        ...
        public Builder withIsResource(boolean isResource) {
