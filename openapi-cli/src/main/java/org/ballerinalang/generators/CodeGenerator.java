...
public class CodeGenerator {
     ...
     * Use {@link #generateBalSource(GenType, String, String, String, Filter) generate}
     * and implement a file write functionality your self, if you need to customize file writing steps.
     * Otherwise use {@link #generate(GenType, String, String, String, String, String, Filter)
     * generate}
    ...
    private List<GenSrcFile> generateBallerinaService(Path api, String serviceName, Filter filter)
        ...
        SyntaxTree syntaxTree = BallerinaServiceGenerator.generateSyntaxTree(api, serviceName, filter);
