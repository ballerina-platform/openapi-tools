...
public class BallerinaSchemaGenerator {
            ...
            if (components.getSchemas() != null) {
                ...
                for (Map.Entry<String, Schema> schema: schemas.entrySet()) {
                    ...
                    IdentifierToken typeName = AbstractNodeFactory.createIdentifierToken(
                            getValidName(schema.getKey().trim()));
                        ...
                        if (composedSchema.getAllOf() != null) {
                            ...
                            for (Schema allOfschema: allOf) {
                                if (allOfschema.getType() == null && allOfschema.get$ref() != null) {
                                    ...
                                    Token typeRef =
                                            AbstractNodeFactory.createIdentifierToken(getValidName(
     ...
     */
    public static void addRecordFields(List<String> required, List<Node> recordFieldList,
                ...
                if (schema instanceof ArraySchema) {
                    ...
                    if (arraySchema.getItems() != null) {
                        ...
                        if (schemaItem.get$ref() != null) {
                            ...
                            typeName = AbstractNodeFactory.createIdentifierToken(getValidName(type));
