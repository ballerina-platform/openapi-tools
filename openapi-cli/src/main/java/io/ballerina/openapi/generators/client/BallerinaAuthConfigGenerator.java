...
import static io.ballerina.openapi.generators.GeneratorConstants.CACHE_CONFIG;
import static io.ballerina.openapi.generators.GeneratorConstants.CACHE_CONFIG_FIELD;
import static io.ballerina.openapi.generators.GeneratorConstants.CHUNKING;
import static io.ballerina.openapi.generators.GeneratorConstants.CLIENT_CRED;
import static io.ballerina.openapi.generators.GeneratorConstants.CLIENT_HTTP1_SETTINGS;
import static io.ballerina.openapi.generators.GeneratorConstants.CLIENT_HTTP1_SETTINGS_FIELD;
...
import static io.ballerina.openapi.generators.GeneratorConstants.ENSURE_TYPE;
import static io.ballerina.openapi.generators.GeneratorConstants.HTTP;
import static io.ballerina.openapi.generators.GeneratorConstants.HTTP2_SETTINGS;
import static io.ballerina.openapi.generators.GeneratorConstants.HTTP2_SETTINGS_FIELD;
import static io.ballerina.openapi.generators.GeneratorConstants.HTTP_CLIENT_CONFIG;
import static io.ballerina.openapi.generators.GeneratorConstants.HTTP_VERSION;
import static io.ballerina.openapi.generators.GeneratorConstants.KEEP_ALIVE;
...
import static io.ballerina.openapi.generators.GeneratorConstants.PROXY;
...
import static io.ballerina.openapi.generators.GeneratorConstants.RESPONSE_LIMIT;
import static io.ballerina.openapi.generators.GeneratorConstants.RESPONSE_LIMIT_FIELD;
import static io.ballerina.openapi.generators.GeneratorConstants.SECURE_SOCKET;
import static io.ballerina.openapi.generators.GeneratorConstants.SECURE_SOCKET_FIELD;
import static io.ballerina.openapi.generators.GeneratorConstants.SELF;
import static io.ballerina.openapi.generators.GeneratorConstants.SETTINGS;
...
public class BallerinaAuthConfigGenerator {
     ...
     * {@code ConnectionConfig config, string serviceUrl = "https://petstore.swagger.io:443/v2" }
     * -- ex: Config param for API Key Authentication mechanism.
     * {@code ApiKeysConfig apiKeyConfig, ConnectionConfig config = {},
     ...
     * {@code ApiKeysConfig apiKeyConfig, string serviceUrl; ConnectionConfig config = {}}
     * -- ex: Config param when no authentication mechanism given.
     * {@code ConnectionConfig config = {},
     * string serviceUrl = "https://petstore.swagger.io:443/v2" }
     * Config param when no authentication mechanism given with no server URL
     * {@code string serviceUrl, ConnectionConfig config = {}}
     *
