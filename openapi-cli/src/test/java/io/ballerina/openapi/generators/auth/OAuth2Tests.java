...
public class OAuth2Tests {
    ...
    public Object[][] dataProvider() {
        return new Object[][]{
                {"oauth2_authrization_code.yaml", TestConstants.OAUTH2_CUSTOM_AUTHORIZATION_CODE_CONFIG_REC},
                {"oauth2_authrization_code_without_tokenurl.yaml", TestConstants.OAUTH2_AUTHORIZATION_CODE_CONFIG_REC},
