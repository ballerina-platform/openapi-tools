...
public isolated client class Client {
    ...
    resource isolated function delete rest/api/'2/'field/[string fieldId]/context/[int contextId]/option/[int optionId](map<string|string[]> headers = {}) returns http:Response|error {
    ...
    resource isolated function delete rest/api/'2/attachment/[string id](map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/attachment/${getEncodedUri(id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/comment/[string commentId]/properties/[string propertyKey](map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/comment/${getEncodedUri(commentId)}/properties/${getEncodedUri(propertyKey)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/component/[string id](map<string|string[]> headers = {}, *DeleteComponentQueries queries) returns http:Response|error {
        string resourcePath = string `/rest/api/2/component/${getEncodedUri(id)}`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/dashboard/[string dashboardId]/items/[string itemId]/properties/[string propertyKey](map<string|string[]> headers = {}) returns http:Response|error {
    ...
    resource isolated function delete rest/api/'2/dashboard/[string id](map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/dashboard/${getEncodedUri(id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/filter/[int id](map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/filter/${getEncodedUri(id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/filter/[int id]/columns(map<string|string[]> headers = {}) returns http:Response|error {
    ...
    resource isolated function delete rest/api/'2/filter/[int id]/permission/[int permissionId](map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/filter/${getEncodedUri(id)}/permission/${getEncodedUri(permissionId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/group(map<string|string[]> headers = {}, *RemoveGroupQueries queries) returns http:Response|error {
        string resourcePath = string `/rest/api/2/group`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/group/user(map<string|string[]> headers = {}, *RemoveUserFromGroupQueries queries) returns http:Response|error {
        string resourcePath = string `/rest/api/2/group/user`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/issue/[string issueIdOrKey](map<string|string[]> headers = {}, *DeleteIssueQueries queries) returns http:Response|error {
        string resourcePath = string `/rest/api/2/issue/${getEncodedUri(issueIdOrKey)}`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/issue/[string issueIdOrKey]/comment/[string id](map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/issue/${getEncodedUri(issueIdOrKey)}/comment/${getEncodedUri(id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/issue/[string issueIdOrKey]/properties/[string propertyKey](map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/issue/${getEncodedUri(issueIdOrKey)}/properties/${getEncodedUri(propertyKey)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/issue/[string issueIdOrKey]/remotelink(map<string|string[]> headers = {}, *DeleteRemoteIssueLinkByGlobalIdQueries queries) returns http:Response|error {
        string resourcePath = string `/rest/api/2/issue/${getEncodedUri(issueIdOrKey)}/remotelink`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/issue/[string issueIdOrKey]/remotelink/[string linkId](map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/issue/${getEncodedUri(issueIdOrKey)}/remotelink/${getEncodedUri(linkId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/issue/[string issueIdOrKey]/votes(map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/issue/${getEncodedUri(issueIdOrKey)}/votes`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/issue/[string issueIdOrKey]/watchers(map<string|string[]> headers = {}, *RemoveWatcherQueries queries) returns http:Response|error {
        string resourcePath = string `/rest/api/2/issue/${getEncodedUri(issueIdOrKey)}/watchers`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/issue/[string issueIdOrKey]/worklog/[string id](map<string|string[]> headers = {}, *DeleteWorklogQueries queries) returns http:Response|error {
        string resourcePath = string `/rest/api/2/issue/${getEncodedUri(issueIdOrKey)}/worklog/${getEncodedUri(id)}`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/issue/[string issueIdOrKey]/worklog/[string worklogId]/properties/[string propertyKey](map<string|string[]> headers = {}) returns http:Response|error {
    ...
    resource isolated function delete rest/api/'2/issue/properties/[string propertyKey](map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/issue/properties/${getEncodedUri(propertyKey)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/issueLink/[string linkId](map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/issueLink/${getEncodedUri(linkId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/issueLinkType/[string issueLinkTypeId](map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/issueLinkType/${getEncodedUri(issueLinkTypeId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/issuetype/[string id](map<string|string[]> headers = {}, *DeleteIssueTypeQueries queries) returns http:Response|error {
        string resourcePath = string `/rest/api/2/issuetype/${getEncodedUri(id)}`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/issuetype/[string issueTypeId]/properties/[string propertyKey](map<string|string[]> headers = {}) returns http:Response|error {
    ...
    resource isolated function delete rest/api/'2/mypreferences(map<string|string[]> headers = {}, *RemovePreferenceQueries queries) returns http:Response|error {
    ...
    resource isolated function delete rest/api/'2/permissionscheme/[int schemeId](map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/permissionscheme/${getEncodedUri(schemeId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/permissionscheme/[int schemeId]/permission/[int permissionId](map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/permissionscheme/${getEncodedUri(schemeId)}/permission/${getEncodedUri(permissionId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/project/[string projectIdOrKey](map<string|string[]> headers = {}, *DeleteProjectQueries queries) returns http:Response|error {
        string resourcePath = string `/rest/api/2/project/${getEncodedUri(projectIdOrKey)}`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/project/[string projectIdOrKey]/avatar/[int id](map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/project/${getEncodedUri(projectIdOrKey)}/avatar/${getEncodedUri(id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/project/[string projectIdOrKey]/properties/[string propertyKey](map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/project/${getEncodedUri(projectIdOrKey)}/properties/${getEncodedUri(propertyKey)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/project/[string projectIdOrKey]/role/[int id](map<string|string[]> headers = {}, *DeleteActorQueries queries) returns http:Response|error {
        string resourcePath = string `/rest/api/2/project/${getEncodedUri(projectIdOrKey)}/role/${getEncodedUri(id)}`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/projectCategory/[int id](map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/projectCategory/${getEncodedUri(id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/role/[int id](map<string|string[]> headers = {}, *DeleteProjectRoleQueries queries) returns http:Response|error {
    ...
    resource isolated function delete rest/api/'2/screens/[int screenId](map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/screens/${getEncodedUri(screenId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/screens/[int screenId]/tabs/[int tabId](map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/screens/${getEncodedUri(screenId)}/tabs/${getEncodedUri(tabId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/screens/[int screenId]/tabs/[int tabId]/fields/[string id](map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/screens/${getEncodedUri(screenId)}/tabs/${getEncodedUri(tabId)}/fields/${getEncodedUri(id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/screenscheme/[string screenSchemeId](map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/screenscheme/${getEncodedUri(screenSchemeId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/universal_avatar/'type/["project"|"issuetype" 'type]/owner/[string owningObjectId]/avatar/[int id](map<string|string[]> headers = {}) returns http:Response|error {
    ...
    resource isolated function delete rest/api/'2/user(map<string|string[]> headers = {}, *RemoveUserQueries queries) returns http:Response|error {
        string resourcePath = string `/rest/api/2/user`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/user/columns(map<string|string[]> headers = {}, *ResetUserColumnsQueries queries) returns http:Response|error {
        string resourcePath = string `/rest/api/2/user/columns`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/user/properties/[string propertyKey](map<string|string[]> headers = {}, *DeleteUserPropertyQueries queries) returns http:Response|error {
        string resourcePath = string `/rest/api/2/user/properties/${getEncodedUri(propertyKey)}`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/version/[string id](map<string|string[]> headers = {}, *DeleteVersionQueries queries) returns http:Response|error {
        string resourcePath = string `/rest/api/2/version/${getEncodedUri(id)}`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/webhook(map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/webhook`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/workflow/[string entityId](map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/workflow/${getEncodedUri(entityId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/workflow/transitions/[int transitionId]/properties(map<string|string[]> headers = {}, *DeleteWorkflowTransitionPropertyQueries queries) returns http:Response|error {
        string resourcePath = string `/rest/api/2/workflow/transitions/${getEncodedUri(transitionId)}/properties`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete rest/api/'2/workflowscheme/[int id](map<string|string[]> headers = {}) returns http:Response|error {
    ...
    resource isolated function delete rest/api/'2/workflowscheme/[int id]/draft(map<string|string[]> headers = {}) returns http:Response|error {
    ...
    resource isolated function delete rest/api/'2/workflowscheme/[int id]/draft/workflow(map<string|string[]> headers = {}, *DeleteDraftWorkflowMappingQueries queries) returns http:Response|error {
    ...
    resource isolated function delete rest/api/'2/workflowscheme/[int id]/workflow(map<string|string[]> headers = {}, *DeleteWorkflowMappingQueries queries) returns http:Response|error {
    ...
    resource isolated function post rest/api/'2/issue/[string issueIdOrKey]/attachments(http:Request request, map<string|string[]> headers = {}) returns Attachment[]|error {
    ...
    resource isolated function post rest/api/'2/issue/properties(IssueEntityProperties payload, map<string|string[]> headers = {}) returns http:Response|error {
    ...
    resource isolated function put rest/api/'2/issue/properties/[string propertyKey](BulkIssuePropertyUpdateRequest payload, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/rest/api/2/issue/properties/${getEncodedUri(propertyKey)}`;
        http:Request request = new;
        json jsonBody = payload.toJson();
        request.setPayload(jsonBody, "application/json");
