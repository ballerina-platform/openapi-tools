...
/**
 * This {@code ConstraintGeneratorDiagnostic} class for containing the diagnostic
 * related to openapi to ballerina constraint generation command.
 *
 * @since 1.9.0
 */
public class ConstraintGeneratorDiagnostic extends Diagnostic {
    private final DiagnosticInfo diagnosticInfo;

    public ConstraintGeneratorDiagnostic(ConstraintDiagnosticMessages diagnostic, String... args) {
