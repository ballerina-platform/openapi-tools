...
public class GeneratorConstants {
    ...
    public static final String REGEX_INCLUDE_ONLY_LETTERS = "\\b[_a-zA-Z][_a-zA-Z0-9]*\\b";
    public static final String REGEX_WORDS_STARTING_WITH_NUMBER = "^[0-9].*";
    public static final String REGEX_NUMBERS_WITH_SPECIAL_CHARACTER = "\\b[0-9([\\[\\]\\\\?!<>@#&~'`*\\-=^+();" +
            ":\\/{}\\s|.$])]*\\b";
