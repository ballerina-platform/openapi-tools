 ...
 * @since 1.3.0
 */
public class InvalidReferenceException extends BallerinaOpenApiException {

    public InvalidReferenceException(String referenceValue) {
        super(new CommonDiagnostic(CommonDiagnosticMessages.OAS_COMMON_201, referenceValue));
    }
}
