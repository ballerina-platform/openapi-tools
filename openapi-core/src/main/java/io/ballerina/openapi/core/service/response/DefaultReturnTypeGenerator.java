    ...
    private TypeDescriptorNode handleMultipleResponse(ApiResponses responses, String httpMethod, OpenAPI openAPI)
        ...
        for (Map.Entry<String, ApiResponse> response : responses.entrySet()) {
            ...
            if (responseValue != null && responseValue.get$ref() != null) {
                ...
                responseValue = oasServiceMetadata.getOpenAPI()
                        .getComponents().getResponses().get(extractReferenceType);
            ...
            if (responseCode.equals(GeneratorConstants.DEFAULT)) {
                ...
                if (isWithOutStatusCode) {
                    ...
                    TypeDescriptorNode statusCodeTypeInclusionRecord = generateStatusCodeTypeInclusionRecord(code,
                            responseValue, httpMethod, openAPI, path);
    ...
    private ReturnTypeDescriptorNode handleSingleResponse(Map.Entry<String, ApiResponse> response, String httpMethod)
        ...
        if (responseContent == null && responseValue.get$ref() == null ||
            ...
            if (isWithOutStatusCode) {
                ...
                String code = GeneratorConstants.HTTP_CODES_DES.get(response.getKey().trim());
                TypeDescriptorNode statusCodeTypeInclusionRecord = generateStatusCodeTypeInclusionRecord(code,
                        responseValue, httpMethod, oasServiceMetadata.getOpenAPI(), path);
