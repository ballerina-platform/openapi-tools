 ...
 * @since 1.3.0
 */
public class NullPathParameterException extends BallerinaOpenApiException {

    public NullPathParameterException() {
        super(new CommonDiagnostic(CommonDiagnosticMessages.OAS_COMMON_203));
    }
}
