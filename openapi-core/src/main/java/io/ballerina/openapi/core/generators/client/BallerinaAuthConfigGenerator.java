...
import static io.ballerina.openapi.core.GeneratorConstants.AUTH_CONFIG;
import static io.ballerina.openapi.core.GeneratorConstants.AUTH_CONFIG_RECORD;
...
import static io.ballerina.openapi.core.GeneratorConstants.CONFIG_RECORD_ARG;
...
public class BallerinaAuthConfigGenerator {
    ...
    public TypeDefinitionNode getOAuth2ClientCredsGrantConfigRecord() {
        Token typeName = AbstractNodeFactory.createIdentifierToken(
                GeneratorConstants.AuthConfigTypes.CUSTOM_CLIENT_CREDENTIAL.getValue());
    ...
    public TypeDefinitionNode getOAuth2PasswordGrantConfigRecord() {
        Token typeName = AbstractNodeFactory.createIdentifierToken(
                GeneratorConstants.AuthConfigTypes.CUSTOM_PASSWORD.getValue());
    ...
    public TypeDefinitionNode getOAuth2RefreshTokenGrantConfigRecord() {
        Token typeName = AbstractNodeFactory.createIdentifierToken(
                GeneratorConstants.AuthConfigTypes.CUSTOM_REFRESH_TOKEN.getValue());
