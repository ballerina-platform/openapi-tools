...
public class RemoteExternalFunctionGenerator extends RemoteFunctionGenerator {
    ...
    protected Optional<FunctionDefinitionNode> getFunctionDefinitionNode(NodeList<Token> qualifierList,
        ...
        MappingConstructorExpressionNode implFunctionMap = createMappingConstructorExpressionNode(createIdentifierToken(OPEN_BRACE),
                createSeparatedNodeList(implFuncNameField), createToken(CLOSE_PAREN_TOKEN));
    ...
    protected Optional<FunctionBodyNode> getFunctionBodyNode() {
        ...
        MappingConstructorExpressionNode methodMapExp = createMappingConstructorExpressionNode(createIdentifierToken(OPEN_BRACE),
                createSeparatedNodeList(classFieldNode, methodFieldNode), createToken(CLOSE_PAREN_TOKEN));
