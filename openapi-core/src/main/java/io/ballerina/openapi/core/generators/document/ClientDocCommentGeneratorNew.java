...
public class ClientDocCommentGeneratorNew implements DocCommentsGenerator {
    OpenAPI openAPI;
    SyntaxTree syntaxTree;
    boolean isResource;

    public ClientDocCommentGeneratorNew(SyntaxTree syntaxTree, OpenAPI openAPI, boolean isResource) {
