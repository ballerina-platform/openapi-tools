...
package org.ballerinalang.ballerina.util;
...
public class ConverterUtils {
    ...
    public static String convertBallerinaTypeToOpenAPIType(String type) {
        ...
        switch (type) {
            case org.ballerinalang.ballerina.util.Constants.INT:
                convertedType = org.ballerinalang.ballerina.util.Constants.OpenAPIType.INTEGER.toString();
                break;
            case org.ballerinalang.ballerina.util.Constants.STRING:
                convertedType = org.ballerinalang.ballerina.util.Constants.OpenAPIType.STRING.toString();
                break;
            case org.ballerinalang.ballerina.util.Constants.BOOLEAN:
                convertedType = org.ballerinalang.ballerina.util.Constants.OpenAPIType.BOOLEAN.toString();
                break;
            case org.ballerinalang.ballerina.util.Constants.ARRAY:
                convertedType = org.ballerinalang.ballerina.util.Constants.OpenAPIType.ARRAY.toString();
                break;
            case org.ballerinalang.ballerina.util.Constants.RECORD:
                convertedType = org.ballerinalang.ballerina.util.Constants.OpenAPIType.RECORD.toString();
                break;
            case org.ballerinalang.ballerina.util.Constants.DECIMAL:
